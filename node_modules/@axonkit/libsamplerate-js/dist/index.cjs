...
function resolveDefaultWasmUrl() {
    try {
        return new URL('./wasm/libsamplerate.wasm', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href))).href;
    }
    catch {
...
function resolveDefaultGlueUrl() {
    ...
    try {
        return new URL('./wasm/libsamplerate.js', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href))).href;
    }
    catch {
...
exports.ConverterType = ConverterType;
exports.SRC = SRC;
