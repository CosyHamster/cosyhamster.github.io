...
export class IsobmffMuxer extends Muxer {
    ...
    getVideoTrackData(track, packet, meta) {
        ...
        // as the timescale.
        const timescale = computeRationalApproximation(1 / (track.metadata.frameRate ?? GLOBAL_TIMESCALE), 1e6).denominator;
    ...
    async addEncodedAudioPacket(track, packet, meta) {
        ...
        try {
            ...
            let timestamp = this.validateAndNormalizeTimestamp(trackData.track, packet.timestamp, packet.type === 'key');
