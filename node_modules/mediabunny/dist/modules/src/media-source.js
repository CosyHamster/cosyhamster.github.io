...
import { assert, assertNever, binarySearchLessOrEqual, CallSerializer, ceilToMultipleOfTwo, clamp, clearIntervalUnthrottled, floorToDivisor, isFirefox, last, normalizeRotation, promiseWithResolvers, roundToDivisor, setInt24, setIntervalUnthrottled, setUint24, toUint8Array, } from './misc.js';
...
import { AudioSample, audioSampleToInterleavedFormat, clampCropRectangle, toInterleavedAudioFormat, VideoSample, } from './sample.js';
...
class VideoEncoderWrapper {
    constructor(source, encodingConfig) {
        ...
        if (['fill', 'contain', 'cover'].includes(sizeChangeBehavior) && encodingConfig.transform?.fit !== undefined) {
            throw new TypeError(`Cannot set 'fit' when 'sizeChangeBehavior' is '${sizeChangeBehavior}'. `
